...
namespace Daimler.Controllers
{
    public class DutyPaymentRequestDetailController : Controller
    {
        ...
        {
            ViewData["HeaderId"] = new SelectList(_context.DutyPaymentRequestHeader, "Id", "Id");
            ViewData["IscExcelAttachmentId"] = new SelectList(_context.AttachmentFileList, "Id", "Id");
            ViewData["IscPdfAttachmentId"] = new SelectList(_context.AttachmentFileList, "Id", "Id");
            ViewData["IdtPdfAttachmentId"] = new SelectList(_context.AttachmentFileList, "Id", "Id");
            ViewData["IdtExcelAttachmentId"] = new SelectList(_context.AttachmentFileList, "Id", "Id"); 
            return View();
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,HeaderId,LineId,DutyValue,RefNo,InvoiceNo,Boeno,PortCode,Boeduty,Fine,Penalty,Interest,IscExcelAttachmentId,IscPdfAttachmentId,IdtPdfAttachmentId,IscExcelAttachmentId,ISC_PDF_AttachmentID,IDT_PDF_AttachmentID,IDT_Excel_AttachmentID,IdtExcelAttachmentId5")] DutyPaymentRequestDetail dutyPaymentRequestDetail)
        {
