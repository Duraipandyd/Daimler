...
namespace Daimler.Controllers
{
    public class AttachmentFileListController : Controller
    {
        ...
        {
            return View(await _context.AttachmentFileList.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var attachmentFileList = await _context.AttachmentFileList
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,SourceId,FileName,Binary,Extension,FileLocation,UserId")] AttachmentFileList attachmentFileList)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var attachmentFileList = await _context.AttachmentFileList.FindAsync(id);
            if (attachmentFileList == null)
            {
                return NotFound();
            }
        ...
        {
            var attachmentFileList = await _context.AttachmentFileList.FindAsync(id);
            _context.AttachmentFileList.Remove(attachmentFileList);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.AttachmentFileList.Any(e => e.Id == id);
        }
    }
}
