...
namespace Daimler.Services
{
    public class IDTService
    {
        ...
        public List<CHAIDTDetailDto> ReadDatafromExcelWorkSheet4IDT(string fileName)
        {
            try
            {
                ...
                var lstIDTDetails = new List<CHAIDTDetailDto>();
                ...
                if (dsexcelRecords != null && dsexcelRecords.Tables.Count > 0)
                {
                    foreach (DataTable excelTable in dsexcelRecords.Tables)
                    {
                        foreach (DataRow dataRow in excelTable.Rows)
                        {
                            ...
                            var IDTDetails = new CHAIDTDetailDto();
                            ...
                            {
                                IDTDetails.Bedate = Convert.ToDateTime(dataRow["Column2"]);
                            }
                            ...
                            IDTDetails.MIDTCharge = CommonFunction.NullToDecimalZero(dataRow["Column11"]);
                            IDTDetails.InvoiceMIDTCurrency = CommonFunction.NullToEmpty(dataRow["Column12"]);
                            ...
                            IDTDetails.SecondaryhigherEducationCessRateExcise = CommonFunction.NullToDecimalZero(dataRow["Column33"]);
                            IDTDetails.SecondaryhigherEducationCessAmountExcise = CommonFunction.NullToDecimalZero(dataRow["Column34"]);
                            IDTDetails.SocialWelfareSurchargeRateCustoms = CommonFunction.NullToDecimalZero(dataRow["Column35"]);
                            IDTDetails.SocialWelfareSurchargeAmountCustoms = CommonFunction.NullToDecimalZero(dataRow["Column36"]);
                            IDTDetails.SecondaryhigherEducationCessRateCustoms = CommonFunction.NullToDecimalZero(dataRow["Column37"]);
                            IDTDetails.SecondaryhigherEducationCessAmountExcise = CommonFunction.NullToDecimalZero(dataRow["Column38"]);
                            IDTDetails.AssessableValue = CommonFunction.NullToDecimalZero(dataRow["Column39"]);
                            IDTDetails.TotalAssessable = CommonFunction.NullToDecimalZero(dataRow["Column40"]);
                            IDTDetails.TotalBasicDuty = CommonFunction.NullToDecimalZero(dataRow["Column41"]);
                            IDTDetails.TotalSurcharge = CommonFunction.NullToDecimalZero(dataRow["Column42"]);
                            IDTDetails.TotalCvd = CommonFunction.NullToDecimalZero(dataRow["Column43"]);
                            IDTDetails.TotalSad  = CommonFunction.NullToDecimalZero(dataRow["Column44"]);
                            IDTDetails.TotalEducationCess = CommonFunction.NullToDecimalZero(dataRow["Column45"]);
                            IDTDetails.TotalEducationCessExcise = CommonFunction.NullToDecimalZero(dataRow["Column46"]);
                            IDTDetails.TotalSocialWelfareSurchargeCustoms = CommonFunction.NullToDecimalZero(dataRow["Column47"]);
                            IDTDetails.TotalSechigherEducationCess = CommonFunction.NullToDecimalZero(dataRow["Column48"]);
                            IDTDetails.TotalSechigherEducationCessExcise = CommonFunction.NullToDecimalZero(dataRow["Column49"]);
                            IDTDetails.TotalSechigherEducationCessCustoms = CommonFunction.NullToDecimalZero(dataRow["Column50"]);
                            IDTDetails.TotalAdditonalDutySubSec5 = CommonFunction.NullToDecimalZero(dataRow["Column51"]);
                            IDTDetails.TotalBasicDuty = CommonFunction.NullToDecimalZero(dataRow["Column52"]);
                            IDTDetails.SplExciseDutySchedIiRate = CommonFunction.NullToDecimalZero(dataRow["Column53"]);
                            IDTDetails.SplExciseDutySchedIiAmount = CommonFunction.NullToDecimalZero(dataRow["Column53"]);
                            IDTDetails.Model = CommonFunction.NullToEmpty(dataRow["Column54"]);
                            IDTDetails.CessdutyRate = CommonFunction.NullToDecimalZero(dataRow["Column55"]);
                            IDTDetails.Cessduty = CommonFunction.NullToDecimalZero(dataRow["Column56"]);
                            IDTDetails.ModeofTransport = CommonFunction.NullToEmpty(dataRow["Column57"]);
                            IDTDetails.Consignor = CommonFunction.NullToEmpty(dataRow["Column58"]);
                            IDTDetails.TaxCode = CommonFunction.NullToEmpty(dataRow["Column59"]);
                            IDTDetails.Igstrate = CommonFunction.NullToDecimalZero(dataRow["Column60"]);
                            IDTDetails.Igstamount= CommonFunction.NullToDecimalZero(dataRow["Column61"]);
                            IDTDetails.AssessableValue = CommonFunction.NullToDecimalZero(dataRow["Column62"]);
