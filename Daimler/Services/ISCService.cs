...
namespace Daimler.Services
{
    public class ISCService
    {
        ...
        public List<CHAISCDetailDto> ReadDatafromExcelWorkSheet4ISC(string fileName)
        {
            try
            {
                ...
                var lstISCDetais = new List<CHAISCDetailDto>();
                ...
                if (dsexcelRecords != null && dsexcelRecords.Tables.Count > 0)
                {
                    foreach (DataTable excelTable in dsexcelRecords.Tables)
                    {
                        foreach (DataRow dataRow in excelTable.Rows)
                        {
                          ...
                          var  ISCDetais = new CHAISCDetailDto();
                            ...
                            {
                                ISCDetais.Bedate = Convert.ToDateTime(dataRow["Column2"]);
                            }
        ...
        public partial class CHAISCDetailDto
        {
